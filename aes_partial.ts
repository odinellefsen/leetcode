...
export function aesInverseFinalRound(
  state: Uint8Array,
  keyForRound: Uint8Array,
): Uint8Array {
  return invSubBytes(invShiftRows(addRoundKey(state, keyForRound)));
}

export function encryptBlock128(block: Uint8Array, key: Uint8Array): Uint8Array {
  assertBlock(block);
  assertKey128(key);
